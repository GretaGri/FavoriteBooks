...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void insertBook(){
            ...
            if (newRowId == -1) Toast.makeText(this,"Error with saving products", Toast.LENGTH_LONG).show();
            else Toast.makeText(this,"Product saved with id " + newRowId, Toast.LENGTH_LONG).show();
